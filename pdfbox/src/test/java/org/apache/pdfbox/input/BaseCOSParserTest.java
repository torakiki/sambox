...
public class BaseCOSParserTest
{
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("1".getBytes()));
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("[10 (A String) endobj".getBytes()));
        COSArray result = victim.nextArray();
        assertEquals(10, result.getInt(0));
        assertEquals(COSString.newInstance("A String".getBytes(Charsets.ISO_8859_1)), result.get(1));
    }
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("<</R 10>>".getBytes()));
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("<< /R 10  endobj".getBytes()));
        COSDictionary result = victim.nextDictionary();
        assertEquals(10, result.getInt(COSName.R));
    }
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("<< /R 10  endstream".getBytes()));
        COSDictionary result = victim.nextDictionary();
        assertEquals(10, result.getInt(COSName.R));
    }
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("<< /R 10  invalid".getBytes()));
        COSDictionary result = victim.nextDictionary();
        assertEquals(10, result.getInt(COSName.R));
    }
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("<< /R Chuck >>".getBytes()));
        COSDictionary result = victim.nextDictionary();
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("1.23".getBytes()));
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("1.23 5".getBytes()));
        COSBase result = victim.nextNumberOrIndirectReference();
        assertThat(result, is(instanceOf(COSFloat.class)));
        assertEquals(1.23f, ((COSFloat) result).floatValue(), 0);
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("10 0 R".getBytes()));
        COSBase result = victim.nextNumberOrIndirectReference();
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom("1.23 5 R".getBytes()));
    ...
    {
        victim = new BaseCOSParser(inMemorySeekableSourceFrom(getClass().getResourceAsStream(
                "/input/stream.txt")));
