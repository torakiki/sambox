...
{
    private static final Logger LOG = LoggerFactory.getLogger(PDUnderlineAppearanceHandler.class);
    ...
    public void generateNormalAppearance()
    {
        ...
        try (PDAppearanceContentStream cs = getNormalAppearanceAsContentStream())
        {
            ...
            for (int i = 0; i < pathsArray.length / 8; ++i)
            {
                ...
                float len0 = (float) (Math
                        .sqrt(Math.pow(pathsArray[i * 8] - pathsArray[i * 8 + 4], 2)
                ...
                float len1 = (float) (Math
                        .sqrt(Math.pow(pathsArray[i * 8 + 2] - pathsArray[i * 8 + 6], 2)
