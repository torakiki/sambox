            ...
            for (int x = 0; x < width; x++)
            {
                ...
                if (isSoft)
                {
                    ...
                    if (matte != null && alphaRow[x] != 0)
                    {
                        ...
                        rgbaRow[offset + 0] = clampColor(
                                ((rgbaRow[offset + 0] / 255f - matte[0]) / k + matte[0]) * 255f);
                        rgbaRow[offset + 1] = clampColor(
                                ((rgbaRow[offset + 1] / 255f - matte[1]) / k + matte[1]) * 255f);
                        rgbaRow[offset + 2] = clampColor(
                                ((rgbaRow[offset + 2] / 255f - matte[2]) / k + matte[2]) * 255f);
                    }
                }
                else
                {
