...
abstract class PDMeshBasedShadingType extends PDShadingType4
{
     ...
     * @param controlPoints number of control points, 12 for type 6 shading and 16 for type 7
     *                      shading
     ...
     * @param matrix              the pattern matrix concatenated with that of the parent content
     *                            stream
     * @param xform               transformation for user to device space
     * @param controlPoints       number of control points, 12 for type 6 shading and 16 for type 7
     *                            shading
    ...
    /**
     * Create a patch using control points and 4 corner color values, in Type6ShadingContext, a
     * CoonsPatch is returned; in Type6ShadingContext, a TensorPatch is returned.
     *
