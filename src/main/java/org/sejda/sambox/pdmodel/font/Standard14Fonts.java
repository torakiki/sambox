...
final class Standard14Fonts
{
    ...
    /**
     * Contains all base names and alias names for the known fonts. For base fonts both the key and
     * the value will be the base name. For aliases, the key is an alias, and the value is a base
     * name. We want a single lookup in the map to find the font both by a base name or an alias.
     */
    private static final Map<String, String> ALIASES = new HashMap<>(38);

    /**
     * Contains the font metrics for the base fonts. The key is a base font name, value is a
     * FontMetrics instance. Metrics are loaded into this map on demand, only if needed.
     *
     * @see #getAFM
     */
     ...
     * jar under /org/sejda/sambox/resources/afm/
     *
    ...
    /**
     * Adds a standard font name to the map of known aliases, to simplify the logic of finding font
     * metrics by name. We want a single lookup in the map to find the font both by a base name or
     * an alias.
     *
     ...
     * @return true if the given font name is one of the known names, including alias.
     */
    ...
    /**
     * @return the set of known font names, including aliases.
     */
     ...
     * @return the base name of the font which the given font name maps to.
     */
