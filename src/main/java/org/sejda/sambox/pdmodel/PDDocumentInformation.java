...
public class PDDocumentInformation extends PDDictionaryWrapper
{
    ...
    /**
     * @return The title of the document or null if no title exists.
     */
    ...
    /**
     * @return The author of the document or null if no author exists.
     */
    ...
    /**
     * @return The subject of the document or null if no subject exists.
     */
    ...
    /**
     * @return The keywords of the document or null if no or null if no author exists. exists.
     */
    ...
    /**
     * @return The creator of the document or null if no creator exists.
     */
    ...
    /**
     * @return The producer of the document or null if no producer exists.
     */
    ...
    /**
     * @return The creation date of the document or null if no creation date exists.
     */
    ...
    /**
     * @return The modification date of the document or null if no modification date exists.
     */
    ...
    /**
     * @return The trapped value for the document or null if one is not found.
     */
     ...
     * @return String Value of a custom metadata field or null if one is not found.
     */
