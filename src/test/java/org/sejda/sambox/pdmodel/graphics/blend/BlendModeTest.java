...
public class BlendModeTest
{
    ...
    /**
     * Check that BlendMode.* constant instances are not null. This could happen if the declaration sequence is changed.
     */
    @Test
    ...
    /**
     * Check that COSName constants returned for BlendMode.* instances are not null. This could happen if the
     * declaration sequence is changed.
     */
    @Test
