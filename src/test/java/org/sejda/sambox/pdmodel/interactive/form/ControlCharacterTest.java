 ...
 * 
 * Compare the results of setting the values using PDFBox with setting the values via Acrobat using JavaScript and
 * manual input.
 * 
 ...
 * </pre>
 * 
 * @see <a href="https://issues.apache.org/jira/browse/PDFBOX-3461">https://issues.apache.org/jira/browse/PDFBOX-3461
 * </a>
 * 
 */
public class ControlCharacterTest
{
    ...
    public void setUp() throws IOException
    {
        document = PDFParser
                .parse(SeekableSources.inMemorySeekableSourceFrom(getClass().getResourceAsStream(
                        "/org/sejda/sambox/pdmodel/interactive/form/ControlCharacters.pdf")));
    ...
    public void characterUnicodeParagraphbreak() throws IOException
    {
        ...
        List<String> pdfboxValues = getStringsFromStream(field);
        List<String> acrobatValues = getStringsFromStream(
                acroForm.getField("acrobat-paragraphbreak"));
