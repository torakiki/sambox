...
public class TestFields extends TestCase
{
    ...
    private static final String PATH_OF_PDF = "src/test/resources/org/sejda/sambox/pdmodel/interactive/form/AcroFormsBasicFields.pdf";
    ...
    public void testAcroFormsBasicFields() throws IOException
    {
        try (PDDocument doc = PDFParser
                .parse(SeekableSources.seekableSourceFrom(new File(PATH_OF_PDF))))
        {
            ...
            assertNotNull(textField);
            assertEquals("org.sejda.sambox.cos.COSStream",
