 ...
 */
class PDPageFitRectangleDestinationTest
{

    @Test
    void transform()
    {
        PDPageFitRectangleDestination victim = new PDPageFitRectangleDestination();
        victim.setTop(10);
        victim.setLeft(50);
        victim.setRight(100);
        victim.setBottom(200);
        victim.transform(new Matrix(AffineTransform.getTranslateInstance(20, 10)));
        Assertions.assertEquals(70, victim.getLeft());
        Assertions.assertEquals(20, victim.getTop());
        Assertions.assertEquals(120, victim.getRight());
        Assertions.assertEquals(210, victim.getBottom());
    }
}