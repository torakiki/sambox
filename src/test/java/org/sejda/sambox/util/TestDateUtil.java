...
public class TestDateUtil
{
    ...
    private static void checkParse(int yr, int mon, int day, int hr, int min, int sec,
            int offsetHours, int offsetMinutes, String orig) throws Exception
    {
        String pdfDate = String.format(Locale.US, "D:%04d%02d%02d%02d%02d%02d%+03d'%02d'", yr, mon,
                day, hr, min, sec, offsetHours, offsetMinutes);
        String iso8601Date = String.format(Locale.US,
                "%04d-%02d-%02d" + "T%02d:%02d:%02d%+03d:%02d", yr, mon, day, hr, min, sec,
    ...
    public void testDateConverter() throws Exception
    {
        ...
        checkParse(BAD, 0, 0, 0, 0, 0, 0, 0, "20070430193647+713'00' illegal tz hr"); // PDFBOX-465
